...
parser.add_argument('-b', nargs="+", type=str, help='biomass reaction')
...
try:
	mlab.Cobra_Methods_try(model,description,ub_biomass,biomass_reaction)
except NameError:
	mlab.Cobra_Methods_try(model,description)
