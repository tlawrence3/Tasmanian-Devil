...
def iterativePrunning(i, m, cH, description, biomassRxn, lb_biomass,
                      repetition, hfr, thresh = 1E-10, EXrxns = [],
        ...
        while EXrxnsprune:
            ...
            try:
                mTemp1 = pruneRxn(mTemp1, cH, rxn1, thresh, description,
                                  repetition, biomassRxn, lb_biomass, hfr)
                EXrxnsprune2 = []
        ...
        for i in range(numProc):
            for j in range(numRep):
                ...
                try:
                    ...
                    cr = iterativePrunning(i, m, cH2, description, biomassRxn, lb_biomass, repetition, new_hfr, activityThreshold, EXrxns, EXtrrxns, Othertrrxns)
                    exportPickle(cr, fOutMbaCandRxns % tag)
                except:
